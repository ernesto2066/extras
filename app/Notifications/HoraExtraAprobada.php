...
class HoraExtraAprobada extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(Actividad $actividad, string $nivel = 'final')
    {
        ...
        \Illuminate\Support\Facades\Log::debug('HoraExtraAprobada::__construct - Notificación creada', [
    ...
    public function via(object $notifiable): array
    {
        ...
        \Illuminate\Support\Facades\Log::debug('HoraExtraAprobada::via - Definiendo canales de envío', [
            'canal' => 'mail',
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        \Illuminate\Support\Facades\Log::debug('HoraExtraAprobada::toMail - Generando mensaje de correo', [
            'actividad_id' => $this->actividad->id,
        ...
        return (new MailMessage)
            ->subject('Hora Extra Aprobada - Claro Data Center')
            ->greeting('Hola ' . $this->actividad->nombre_completo)
            ->line('Nos complace informarte que tu solicitud de hora extra ha sido aprobada ' . $etapa . '.')
            ...
            ->when($this->actividad->comentarios, function ($message) {
                return $message->line('Comentarios: ' . $this->actividad->comentarios);
            })
            ->action('Ver Detalle', url('/'))
            ->line('Gracias por tu trabajo en Claro Data Center!');
    }
